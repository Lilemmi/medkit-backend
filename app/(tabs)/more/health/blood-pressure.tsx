...
export default function BloodPressureScreen() {
  ...
  const loadRecords = async () => {
    try {
      const data = await getHealthMetrics("blood_pressure", user?.id);
  ...
  return (
    ...
    >
      ...
      <View style={[styles.header, { paddingTop: insets.top + 12 }]}>
        ...
        <Text style={styles.headerTitle}>{t("health.bloodPressure")}</Text>
        <View style={{ width: 24 }} />
      </View>

      <View style={styles.form}>
        <Text style={styles.label}>{t("health.systolic")}</Text>
        <TextInput
          style={styles.input}
          placeholder="120"
        ...
        <Text style={styles.label}>{t("health.diastolic")}</Text>
        <TextInput
          style={styles.input}
          placeholder="80"
          placeholderTextColor={colors.textSecondary}
        ...
        <Text style={styles.label}>{t("health.pulseValue")} ({t("common.optional")})</Text>
        <TextInput
          style={styles.input}
          placeholder="70"
          placeholderTextColor={colors.textSecondary}
            ...
            <View style={styles.recordHeader}>
              <View>
                <Text style={styles.recordValue}>
                  {record.value}/{record.value2} mmHg
                </Text>
